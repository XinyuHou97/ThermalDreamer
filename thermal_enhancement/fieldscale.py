...
class Fieldscale:
    def __init__(self, max_diff: float = 400, min_diff: float = 400,
                 iteration: int = 7, gamma: float = 1.5, grid_size: int=8, clahe_clip: int=3,
    ...
    def __call__(self, input: Union[str, np.ndarray]) -> np.ndarray:
        ...
        min_grid = gridwise_min(image, (self.grid_size, self.grid_size))
        max_grid = gridwise_max(image, (self.grid_size, self.grid_size))
