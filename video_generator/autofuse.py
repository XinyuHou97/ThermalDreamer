...
savefolder='/mnt/nas/xinyu/control-a-video/fuse/newauto/'

# savefolder='/mnt/nas/xinyu/control-a-video/fuse/'+args.p+'/'
...
for depthf in depthfiles:
    ...
    # rgb_image_array = np.stack(rgb_image_array, axis=0)
    # gradients = compute_average_gradient(rgb_image_array)
    ...
    for i in range(num_sample_frames//each_sample_frame):
        out1 = video_controlnet_pipe(
                ...
                canny_control_ratio = canny_control,#args.ratio,
