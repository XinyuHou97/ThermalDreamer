...
#         array = predictions[0][0].cpu().numpy()

# # 创建图像
#         import matplotlib.pyplot as plt
#         plt.figure(figsize=(6, 5))
#         im = plt.imshow(array, cmap='viridis')  # 或其它colormap，比如 'plasma', 'inferno', 'jet' 等
#         plt.colorbar(im)  # 添加colorbar
#         plt.axis('off')   # 可选：关闭坐标轴
        
#         # 保存为图像
#         plt.savefig('tensor_image_with_colorbar.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
#         plt.close()
#         # sys.exit()
#         raise SystemExit
    ...
    def __call__(
        ...
        if first_frame_output is not None and first_frame_output_latent is None:
            ...
            print('latents shape!!!:',first_frame_output_latent.shape, first_frame_output_latent.device)
